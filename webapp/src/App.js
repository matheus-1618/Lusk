...
function App() {
  ...
  async function doPostRequest() {
    ...
    let res = await axios.post('https://b82uq64h22.execute-api.us-east-1.amazonaws.com/prod/execution', payload);
    let data = res.data;
    console.log(data);
    setResponse(data);
};
...
async function doGetRequest() {
  let payload = {};
  let res = await axios.post('https://yibpagh39d.execute-api.us-east-1.amazonaws.com/prod/execution', payload);
  let data = res.data;
  console.log(data);
  setValues(data);
};
